...
test('CLI simulation', async () => {
  ...
  // Load script
  const scriptPath = "/tmp/test-bitburner-cli/test-script.js";
  ...
  try {
    fs.unlinkSync("/home/runner/work/bitburner-src/bitburner-src/test/.cli-tmp/cli-test-1764724859045.test.js");
  } catch (e) {
