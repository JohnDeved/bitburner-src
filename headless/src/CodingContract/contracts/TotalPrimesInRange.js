...
exports.totalPrimesInRange = void 0;
const _enums_1 = require("@enums");
const getRandomIntInclusive_1 = require("../../utils/helpers/getRandomIntInclusive");
exports.totalPrimesInRange = {
    [_enums_1.CodingContractName.TotalPrimesInRange]: {
        desc: (data) => {
            return [
        ...
        generate: () => {
            ...
            const low = (0, getRandomIntInclusive_1.getRandomIntInclusive)(0, 5e6);
            const high = low + (0, getRandomIntInclusive_1.getRandomIntInclusive)(1e5, 1e6);
            return [low, high];
        },
        solver: (data, answer) => {
