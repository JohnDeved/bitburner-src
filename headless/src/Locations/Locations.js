...
const LocationsMetadata_1 = require("./data/LocationsMetadata");
exports.Locations = {};
/**
...
Cities_1.Cities[_enums_1.CityName.Aevum].asciiArt = `
...
[galactic cybersystems]  G               35 x                                   
                      ...
                      67 o                                                      
                                    ...
                                    [the slums] P                               `;
Cities_1.Cities[_enums_1.CityName.Chongqing].asciiArt = `
                                    |                                           
                                 75 o                                           
                                     \\                                         
                                      o 76                                      
...
[solaris space system] B            |                                           
                    ...
                    34 o            E [travel agency]                           
                                    ...
                                    x 82                                        
             [the slums] D                                                      `;
Cities_1.Cities[_enums_1.CityName.Ishima].asciiArt = `
                                          o 59                                  
                  o        o              |                                     
 [storm tech.]    |        |              G [world stock exchange]              
   ...
   48 o     /                      55 x       \\ /                              
    ...
    o      50                  52                                               
              [omega soft.]                                                     
                                       [the slums] E                            `;
Cities_1.Cities[_enums_1.CityName.NewTokyo].asciiArt = `
             ...
             [vitalife]              o 12   [global pharmaceuticals]            
               ...
               o--D-x----x-------x-C-+--------x--x-B-x---x-o                    
                  ...
                  o--x--F--x-----x-----x---+---x----x--I--x-o                   
                                           ...
                                           G  [the slums]                       
                                                                                `;
Cities_1.Cities[_enums_1.CityName.Sector12].asciiArt = `
          78                                                     o 97           
...
Cities_1.Cities[_enums_1.CityName.Volhaven].asciiArt = `
                                 [omnia cybersystems]                           
                   17         66               68                               
                  o            o------G-------o                                 
                   \\          /                \\                              
