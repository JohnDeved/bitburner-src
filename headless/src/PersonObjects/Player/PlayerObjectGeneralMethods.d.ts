import { AugmentationName, CompanyName, CompletedProgramName, FactionName, JobName, LocationName } from "@enums";
import type { PlayerObject } from "./PlayerObject";
import type { ProgramFilePath } from "../../Paths/ProgramFilePath";
import { ICodingContractReward } from "../../CodingContract/Contract";
 ...
 */
export declare function applyForJob(this: PlayerObject, company: Company, position: CompanyPosition): Result<{
    jobName: JobName;
}>;
/**
...
export declare function giveAchievement(this: PlayerObject, achievementId: AchievementId): void;
