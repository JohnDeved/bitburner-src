...
export declare function formatBytes(n: number, fractionalDigits?: number): string;
...
export declare const formatMoney: (n: number, useExponentialFormForSmallValue?: boolean) => string;
