...
exports.IndustryResearchTrees = exports.IndustryStartingCosts = exports.IndustriesData = void 0;
exports.resetIndustryResearchTrees = resetIndustryResearchTrees;
const Record_1 = require("../../Types/Record");
const _enums_1 = require("@enums");
const BaseResearchTree_1 = require("./BaseResearchTree");
exports.IndustriesData = {
    [_enums_1.IndustryType.Agriculture]: {
        startingCost: 40e9,
    ...
    [_enums_1.IndustryType.Refinery]: {
        startingCost: 50e9,
    ...
    [_enums_1.IndustryType.Chemical]: {
        startingCost: 70e9,
    ...
    [_enums_1.IndustryType.Computers]: {
        startingCost: 500e9,
    ...
    [_enums_1.IndustryType.Restaurant]: {
        startingCost: 10e9,
    ...
    [_enums_1.IndustryType.Healthcare]: {
        startingCost: 750e9,
    ...
    [_enums_1.IndustryType.Pharmaceutical]: {
        startingCost: 200e9,
    ...
    [_enums_1.IndustryType.RealEstate]: {
        startingCost: 600e9,
    ...
    [_enums_1.IndustryType.Robotics]: {
        startingCost: 1e12,
    ...
    [_enums_1.IndustryType.Software]: {
        startingCost: 25e9,
...
exports.IndustryResearchTrees = (0, Record_1.createFullRecordFromEntries)(Object.values(_enums_1.IndustryType).map((industryType) => {
    return [
        industryType,
        exports.IndustriesData[industryType].product ? (0, BaseResearchTree_1.getProductIndustryResearchTreeCopy)() : (0, BaseResearchTree_1.getBaseResearchTreeCopy)(),
    ];
}));
function resetIndustryResearchTrees() {
    Object.values(_enums_1.IndustryType).forEach((ind) => (exports.IndustryResearchTrees[ind] = exports.IndustriesData[ind].product
        ? (0, BaseResearchTree_1.getProductIndustryResearchTreeCopy)()
        : (0, BaseResearchTree_1.getBaseResearchTreeCopy)()));
}
