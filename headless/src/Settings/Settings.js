...
exports.isValidConnectionHostname = isValidConnectionHostname;
exports.isValidConnectionPort = isValidConnectionPort;
const SettingEnums_1 = require("./SettingEnums");
...
const ErrorState_1 = require("../ErrorHandling/ErrorState");
/**
 ...
 * - etc.
 */
function isValidConnectionHostname(hostname) {
...
function isValidConnectionPort(port) {
...
exports.Settings = {
    ...
    load(saveString) {
        ...
        (0, TypeAssertion_1.assertObject)(save);
        save.overview && Object.assign(exports.Settings.overview, save.overview);
        try {
            // Sanitize theme data. Invalid theme data may crash the game or make it stuck in the loading page.
            (0, JSONSchemaAssertion_1.assertAndSanitizeMainTheme)(save.theme);
            Object.assign(exports.Settings.theme, save.theme);
        }
        catch (error) {
            console.error(error);
        }
        try {
            ...
            (0, JSONSchemaAssertion_1.assertAndSanitizeEditorTheme)(save.EditorTheme);
            Object.assign(exports.Settings.EditorTheme, save.EditorTheme);
        }
        catch (error) {
            console.error(error);
        }
        try {
            // Sanitize styles.
            (0, JSONSchemaAssertion_1.assertAndSanitizeStyles)(save.styles);
            Object.assign(exports.Settings.styles, save.styles);
        }
        catch (error) {
            console.error(error);
        }
        ...
        if (save.KeyBindings !== undefined) {
            try {
                ...
                (0, JSONSchemaAssertion_1.assertAndSanitizeKeyBindings)(save.KeyBindings);
                Object.assign(exports.Settings.KeyBindings, save.KeyBindings);
            }
            catch (error) {
                console.error(error);
            }
        }
        Object.assign(exports.Settings, save, {
            overview: exports.Settings.overview,
            theme: exports.Settings.theme,
            EditorTheme: exports.Settings.EditorTheme,
            styles: exports.Settings.styles,
            KeyBindings: exports.Settings.KeyBindings,
        });
        /**
         ...
         */
        if (!isValidConnectionHostname(exports.Settings.RemoteFileApiAddress).success) {
            exports.Settings.RemoteFileApiAddress = "localhost";
        }
        if (!isValidConnectionPort(exports.Settings.RemoteFileApiPort).success) {
            exports.Settings.RemoteFileApiPort = 0;
        }
        // Merge Settings.KeyBindings with DefaultKeyBindings.
        (0, KeyBindingUtils_1.mergePlayerDefinedKeyBindings)(exports.Settings.KeyBindings);
        // Set up initial state for error modal suppression
        (0, ErrorState_1.toggleSuppressErrorModals)(exports.Settings.SuppressErrorModals, true);
    },
};
