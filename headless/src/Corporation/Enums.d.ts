...
export declare const CreatingCorporationCheckResultEnum: {
    readonly Success: "Success";
    readonly NoSf3OrDisabled: "NoSf3OrDisabled";
    readonly CorporationExists: "CorporationExists";
    readonly UseSeedMoneyOutsideBN3: "UseSeedMoneyOutsideBN3";
    readonly DisabledBySoftCap: "DisabledBySoftCap";
};
