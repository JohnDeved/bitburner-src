...
exports.hammingCode = void 0;
const getRandomIntInclusive_1 = require("../../utils/helpers/getRandomIntInclusive");
const _enums_1 = require("@enums");
exports.hammingCode = {
    [_enums_1.CodingContractName.HammingCodesIntegerToEncodedBinary]: {
        difficulty: 6,
        desc: (n) => {
            return [
        ...
        generate: () => {
            ...
            const y = Math.pow(2, (0, getRandomIntInclusive_1.getRandomIntInclusive)(1, 57));
            return (0, getRandomIntInclusive_1.getRandomIntInclusive)(Math.min(x, y), Math.max(x, y));
        },
        solver: (data, answer) => {
            return HammingEncode(data) === answer;
        },
        convertAnswer: (ans) => ans,
        validateAnswer: (ans) => typeof ans === "string",
    },
    [_enums_1.CodingContractName.HammingCodesEncodedBinaryToInteger]: {
        difficulty: 9,
        desc: (n) => {
            return [
        ...
        generate: () => {
            ...
            const x = Math.pow(2, 4);
            const y = Math.pow(2, (0, getRandomIntInclusive_1.getRandomIntInclusive)(1, 57));
            const _buildArray = HammingEncodeProperly((0, getRandomIntInclusive_1.getRandomIntInclusive)(Math.min(x, y), Math.max(x, y))).split("");
            if (_alteredBit) {
                const _randomIndex = (0, getRandomIntInclusive_1.getRandomIntInclusive)(0, _buildArray.length - 1);
