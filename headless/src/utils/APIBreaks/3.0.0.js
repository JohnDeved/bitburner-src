...
exports.breakingChanges300 = void 0;
exports.convertV2GangEquipmentNames = convertV2GangEquipmentNames;
function convertV2GangEquipmentNames(name) {
    switch (name) {
        case "Glock 18C":
...
exports.breakingChanges300 = {
    additionalText: "For more information, please check https://github.com/bitburner-official/bitburner-src/issues/2148.",
    apiBreakingChanges: [
        {
            brokenAPIs: [],
            info: "You cannot use the deprecated VSCode extension to connect to the Steam app via API server now. You have to " +
        ...
        },
        {
            ...
            info: "The formatting functions have been moved to their own interface, ns.format.\n" +
        ...
        },
        {
            ...
            info: "ns.corporation.setAutoJobAssignment() was removed.\n" +
                'It has been automatically replaced with "ns.corporation.setJobAssignment()".',
            showWarning: false,
        },
        {
            brokenAPIs: [],
            info: "With some APIs, when you passed values to their params, you could pass a value that was not an exact match. " +
        ...
        },
        {
            ...
            info: `ns.nuke, ns.brutessh, ns.ftpcrack, ns.relaysmtp, ns.httpworm, and ns.sqlinject now do not throw an error when you do not have the required .exe file or enough opened ports.\n` +
        ...
        },
        {
            ...
            info: "ns.stock.getConstants().WSEAccountCost was removed.\n" +
        ...
        },
        {
            ...
            info: "ns.getBitNodeMultipliers().RepToDonateToFaction was removed.\n" +
                'It has been automatically replaced with "ns.getBitNodeMultipliers().FavorToDonateToFaction".',
            showWarning: false,
        },
        {
            brokenAPIs: [{ name: "getActionRepGain" }],
            info: "ns.bladeburner.getActionRepGain returned the average rank gain instead of the average reputation gain.\n" +
        ...
        },
        {
            ...
            info: "ns.corporation.getCorporation().dividendTax was removed.\n" +
        ...
        },
        {
            ...
            info: "Some APIs returned a default value when you passed the hostname of a non-hackable server (e.g., hacknet " +
        ...
        },
        {
            ...
            info: "Some gang equipments were renamed.\n" +
        ...
        },
        {
            ...
            info: "You have to purchase a WSE account before purchasing 4S Market Data UI access via ns.stock.purchase4SMarketData().\n" +
