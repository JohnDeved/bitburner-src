...
exports.findAllValidMathExpressions = void 0;
...
exports.findAllValidMathExpressions = {
    [_enums_1.CodingContractName.FindAllValidMathExpressions]: {
        desc: (data) => {
            const digits = data[0];
            const target = data[1];
            return [
        ...
        difficulty: 10,
        generate: () => {
            const numDigits = (0, getRandomIntInclusive_1.getRandomIntInclusive)(4, 12);
            const digitsArray = [];
            digitsArray.length = numDigits;
            for (let i = 0; i < digitsArray.length; ++i) {
                if (i === 0) {
                    digitsArray[i] = String((0, getRandomIntInclusive_1.getRandomIntInclusive)(1, 9));
                }
                else {
                    digitsArray[i] = String((0, getRandomIntInclusive_1.getRandomIntInclusive)(0, 9));
                }
            }
            const target = (0, getRandomIntInclusive_1.getRandomIntInclusive)(-100, 100);
        ...
        convertAnswer: (ans) => {
            ...
            return (0, ArrayHelpers_1.filterTruthy)(sanitized).map((s) => (0, ContractTypes_1.removeQuotesFromString)(s.replace(/\s/g, "")));
        },
