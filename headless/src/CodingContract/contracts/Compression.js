...
exports.compression = {
    [_enums_1.CodingContractName.CompressionIRLECompression]: {
        difficulty: 2,
        desc: (plaintext) => {
            return [
    ...
    [_enums_1.CodingContractName.CompressionIILZDecompression]: {
        difficulty: 4,
        desc: (compressed) => {
            return [
    ...
    [_enums_1.CodingContractName.CompressionIIILZCompression]: {
        difficulty: 10,
        desc: (plaintext) => {
            return [
                "Lempel-Ziv (LZ) compression is a data compression technique which encodes data using references to",
