...
exports.extendAcornWalkForTypeScriptNodes = extendAcornWalkForTypeScriptNodes;
/**
 * From isTypeScript()
 *
...
function extendAcornWalkForTypeScriptNodes(base) {
    ...
    base.TSModuleDeclaration = (node, state, callback) => {
