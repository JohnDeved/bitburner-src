...
exports.proper2ColoringOfAGraph = void 0;
const ContractTypes_1 = require("../ContractTypes");
const _enums_1 = require("@enums");
exports.proper2ColoringOfAGraph = {
    [_enums_1.CodingContractName.Proper2ColoringOfAGraph]: {
        difficulty: 7,
        numTries: 5,
        desc: (data) => {
            return [
        ...
        generate: () => {
            ...
            if (a > b)
                [a, b] = [b, a]; //Enforce lower numbers come first
        ...
        convertAnswer: (ans) => {
            ...
            if (((a) => !a.some((n) => n !== 1 && n !== 0))(arr))
                return arr;
            return null;
        },
        validateAnswer: (ans) => typeof ans === "object" && Array.isArray(ans) && !ans.some((a) => a !== 1 && a !== 0),
    },
};
