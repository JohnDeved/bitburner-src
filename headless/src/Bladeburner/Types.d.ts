...
type AvailabilitySuccess<T extends object> = {
    available: true;
} & T;
...
type AttemptSuccess<T extends object> = {
    success: true;
    message?: string;
} & T;
type AttemptFailure = {
...
export type ActionIdentifier = ActionIdFor<Contract> | ActionIdFor<Operation> | ActionIdFor<BlackOperation> | ActionIdFor<GeneralAction>;
