...
test('CLI simulation', async () => {
  ...
  // Load script
  const scriptPath = "/home/runner/work/bitburner-src/bitburner-src/test/examples/basic-hack.js";
  ...
  try {
    fs.unlinkSync("/home/runner/work/bitburner-src/bitburner-src/test/.cli-tmp/cli-test-1764723934584.test.js");
  } catch (e) {
