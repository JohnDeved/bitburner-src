...
exports.EditorThemeSchema = exports.MainThemeSchema = exports.editorThemeHexColorRegex = exports.themeHexColorRegex = void 0;
 ...
 */
exports.themeHexColorRegex = /^#((([0-9A-Fa-f]{6})([0-9A-Fa-f]{2})?)|([0-9A-Fa-f]{3}))$/;
/**
 ...
 */
exports.editorThemeHexColorRegex = /^((([0-9A-Fa-f]{6})([0-9A-Fa-f]{2})?)|([0-9A-Fa-f]{3}))$/;
function getThemeSchemaProperties() {
    ...
    for (const key of (0, Record_1.getRecordKeys)(result)) {
        result[key].pattern = exports.themeHexColorRegex.source;
    }
    return result;
}
exports.MainThemeSchema = {
    $schema: "http://json-schema.org/draft-07/schema#",
    type: "object",
    properties: getThemeSchemaProperties(),
};
exports.EditorThemeSchema = {
    $schema: "http://json-schema.org/draft-07/schema#",
    type: "object",
    properties: {
        common: {
            ...
            properties: {
                accent: {
                    type: "string",
                    pattern: exports.editorThemeHexColorRegex.source,
                },
                bg: {
                    type: "string",
                    pattern: exports.editorThemeHexColorRegex.source,
        ...
        base: {
             ...
             */
            enum: themes_1.validEditorThemeBases,
        },
        inherit: {
            type: "boolean",
        },
