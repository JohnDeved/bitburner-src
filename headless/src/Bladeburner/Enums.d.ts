export declare enum BladeburnerActionType {
    General = "General",
    Contract = "Contracts",
    Operation = "Operations",
    BlackOp = "Black Operations"
}
export declare enum BladeburnerGeneralActionName {
    Training = "Training",
...
export declare enum SpecialBladeburnerActionTypeForSleeve {
    InfiltrateSynthoids = "Infiltrate Synthoids",
    SupportMainSleeve = "Support main sleeve",
    TakeOnContracts = "Take on contracts"
}
export declare enum BladeburnerContractName {
    Tracking = "Tracking",
    BountyHunter = "Bounty Hunter",
    Retirement = "Retirement"
}
export declare enum BladeburnerOperationName {
...
export declare enum BladeburnerBlackOpName {
...
export declare enum BladeburnerSkillName {
...
export declare enum BladeburnerMultName {
