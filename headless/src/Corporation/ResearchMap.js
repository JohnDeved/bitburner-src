...
exports.ResearchMap = {
    AutoBrew: new Research_1.Research({
        name: "AutoBrew",
        cost: 12e3,
    ...
    AutoPartyManager: new Research_1.Research({
        name: "AutoPartyManager",
        cost: 15e3,
        desc: "Automatically analyzes your employees' morale " +
    ...
    "Automatic Drug Administration": new Research_1.Research({
        name: "Automatic Drug Administration",
        cost: 10e3,
        desc: "Research how to automatically administer performance-enhancing drugs to all of " +
            "your employees. This unlocks Drug-related Research.",
    }),
    "CPH4 Injections": new Research_1.Research({
    ...
    Drones: new Research_1.Research({
        name: "Drones",
        cost: 5e3,
    ...
    "Drones - Assembly": new Research_1.Research({
    ...
    "Drones - Transport": new Research_1.Research({
    ...
    "Go-Juice": new Research_1.Research({
        name: "Go-Juice",
        cost: 25e3,
        desc: "Provide employees with Go-Juice, a tea-derivative that further enhances " +
            "the brain's dopamine production. This increases the maximum energy of all " +
            "employees by 10.",
    }),
    "HRBuddy-Recruitment": new Research_1.Research({
    ...
    "HRBuddy-Training": new Research_1.Research({
    ...
    "Hi-Tech R&D Laboratory": new Research_1.Research({
    ...
    "Market-TA.I": new Research_1.Research({
        name: "Market-TA.I",
        cost: 20e3,
    ...
    "Market-TA.II": new Research_1.Research({
        name: "Market-TA.II",
        cost: 50e3,
    ...
    Overclock: new Research_1.Research({
        name: "Overclock",
        cost: 15e3,
    ...
    "Self-Correcting Assemblers": new Research_1.Research({
    ...
    "Sti.mu": new Research_1.Research({
        name: "Sti.mu",
        cost: 30e3,
    ...
    "uPgrade: Capacity.I": new Research_1.Research({
    ...
    "uPgrade: Capacity.II": new Research_1.Research({
    ...
    "uPgrade: Dashboard": new Research_1.Research({
    ...
    "uPgrade: Fulcrum": new Research_1.Research({
