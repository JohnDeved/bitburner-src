...
exports.defaultMonacoTheme = exports.validEditorThemeBases = void 0;
exports.makeTheme = makeTheme;
exports.loadThemes = loadThemes;
exports.validEditorThemeBases = ["vs", "vs-dark", "hc-black", "hc-light"];
exports.defaultMonacoTheme = {
    base: "vs-dark",
    inherit: true,
    common: {
        accent: "B5CEA8",
...
function loadThemes(defineTheme) {
    defineTheme("monokai", {
        base: "vs-dark",
        inherit: true,
        rules: [
